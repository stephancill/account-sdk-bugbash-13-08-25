...
describe('injectFontStyle', () => {
  beforeEach(() => {
    ...
    const existing = document.head.querySelectorAll('style[data-sdk-font="BaseSans-Regular"]');
  ...
  it('injects font style into document head', () => {
    ...
    const styleElement = document.head.querySelector('style[data-sdk-font="BaseSans-Regular"]');
  ...
  it('sets correct attributes on style element', () => {
    ...
    const styleElement = document.head.querySelector('style[data-sdk-font="BaseSans-Regular"]');
    expect(styleElement).toHaveAttribute('data-sdk-font', 'BaseSans-Regular');
  });
  ...
  it('does not inject duplicate styles', () => {
    ...
    const styleElements = document.head.querySelectorAll('style[data-sdk-font="BaseSans-Regular"]');
  ...
  it('returns early if style already exists', () => {
    ...
    existingStyle.setAttribute('data-sdk-font', 'BaseSans-Regular');
  ...
  it('appends style to document head', () => {
    ...
    expect(lastChild).toHaveAttribute('data-sdk-font', 'BaseSans-Regular');
  });
